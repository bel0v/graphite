...
describe('groups', () => {
  ...
  it('should list groups', () => {
    ...
    expect(nodesGroups.list).toEqual([
      { name: 'group1', id: 1, members: [] },
      { name: 'group2', id: 2, members: [] }
    ])
  })
  ...
  it('should remove a group by name', () => {
    ...
    expect(nodesGroups.list).toEqual([{ name: 'group2', id: 2, members: [] }])
  })
  ...
  it('should get group members by group name', () => {
    const nodesGroups = Groups([
      { name: 'group1', id: 1, members: [1, 2, 3] },
      { name: 'group2', id: 2, members: [4, 5, 6] }
    ])
